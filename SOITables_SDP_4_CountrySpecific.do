					...
					replace region_soi="Boucle de Mouhon" if region_soi=="1" & Country=="Burkina"
					 ...
					 replace region_soi="Plateau-Central" if region_soi=="11" & Country=="Burkina"
						   ...
						   replace region_soi="Sud-Ouest" if region_soi=="13" & Country=="Burkina"
						     ...
						     replace region_soi="Ashanti" if region_soi=="1" & Country=="Ghana"
					     replace region_soi="Brong Ahafo" if region_soi=="2" & Country=="Ghana"
						     replace region_soi="Central" if region_soi=="3" & Country=="Ghana"
						     replace region_soi="Eastern" if region_soi=="4" & Country=="Ghana"
					   replace region_soi="Greater Accra" if region_soi=="5" & Country=="Ghana"
						    replace region_soi="Northern" if region_soi=="6" & Country=="Ghana"
					      replace region_soi="Upper East" if region_soi=="7" & Country=="Ghana"
					      replace region_soi="Upper West" if region_soi=="8" & Country=="Ghana"
							   replace region_soi="Volta" if region_soi=="9" & Country=="Ghana"
							 replace region_soi="Western" if region_soi=="10" & Country=="Ghana"
										  
						   replace region_soi="Java-Bali" if region_soi=="1" & Country=="Indonesia"
							   replace region_soi="Other" if region_soi=="2" & Country=="Indonesia"								  
						   ...
						   replace region_soi="Tillaberi" if region_soi=="7" & (Country=="Niger_Niamey" | Country=="Niger")
						      replace region_soi="Zinder" if region_soi=="8" & (Country=="Niger_Niamey" | Country=="Niger")
								...
								replace region_soi="None" if region_soi=="1" & (Country=="Nigeria_`state'" | Country=="Nigeria_Kaduna" | Country=="Nigeria_Lagos" | Country=="Nigeria")

							 replace region_soi="Central" if region_soi=="1" & Country=="Uganda"
							 replace region_soi="Eastern" if region_soi=="2" & Country=="Uganda"
							replace region_soi="Northern" if region_soi=="3" & Country=="Uganda"
							 replace region_soi="Western" if region_soi=="4" & Country=="Uganda"
...
save "`CCRX'_SOIPrep_SDP_countryspecific.dta", replace
